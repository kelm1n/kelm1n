...
- 📚 Постоянно учусь и развиваюсь во frontend направлении
- 🌱 Всегда применяю современный подход и адаптируюсь к новым технологиям
- 🎯 Стремлюсь к созданию качественных и уникальных продуктов
...
Все мои проекты доступны на моём [персональном сайте](url)

## 🎯 Актуальные цели

- "Добить" изучение React до конца
- Освоить **Backend** разработку
- Участвовать в Open Source проектах
- Набираться опыта на практике
